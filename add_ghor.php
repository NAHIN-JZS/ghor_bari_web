...
<body>
	...
	if (isset($_POST['house_no'])) {
		...
		$sql_enter_new_ghor = "INSERT INTO `house` (`u_id`, `house_no`,`total_room`, `address`, `city`, `cost`, `h_type`, `additional_info`, `size`) VALUES ('$u_id', '$house_no', '$total_room', '$address',  '$city', '$rent_fare', '$h_type', '$additional_info', '$size');";
